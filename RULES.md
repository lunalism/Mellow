...
- V1 Photos Import는 Video Codec이 H.264(`avc1` / `avc3`) 또는 HEVC(`hvc1` / `hev1`) Family인 Source만 받아들이며 ProRes / ProRes RAW / MJPEG / 기타 / Unknown Codec은 Preflight에서 제외한다(Container 다음 · Orientation 이전; Codec Family는 Normalization 사유가 아님; Codec별 안내 문구 없음)(ADR-046).
