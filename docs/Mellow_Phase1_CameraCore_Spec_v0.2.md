...
>
> **[은퇴 노트 추가 2026-07-22]** §4.2 크로스페이드는 대체 확정 — 스틸은 즉시 스왑(L3
> Decision B)으로 필터 전환을 유지하고, 영상은 **녹화 중에만** 필터 잠금(브이로그 테이크
> 무결성, 기획 결정 2026-07-22) — 두 모드 모두 크로스페이드 전환 효과가 불필요하다. 관련
> 미사용 코드 `FrameProcessor.crossfade`는 삭제됨. §4.2 본문은 역사적 기록으로 원문 유지.
